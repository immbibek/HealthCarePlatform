          ...
          <div className="pt-4 border border-t-0">
            {dashData.latestAppointments.map((item, index) => (
              ...
              >
                ...
                {item.cancelled ? (
                  <p className="text-red-500 text-xs font-medium border rounded bg-red-50 p-2 text-center border-red-500">
                    Cancelled
                  </p>
                ) : item.isCompleted ? (
                  <p className="text-green-500 text-xs font-medium border rounded bg-green-50 p-2 text-center border-green-500">
                    Completed
                  </p>
                ) : (
