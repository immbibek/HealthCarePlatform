        ...
        {docInfo.available ? (
          <div className="sm:ml-72 sm:pl-4 mt-4 font-medium text-gray-700">
              ...
              {docslots.length &&
                docslots[slotIndex].map((item, index) => (
                  <p
                    ...
                    className={`text-sm font-light cursor-pointer px-5 py-2 rounded-full flex-shrink-0 ${
                      item.time === slotTime
                        ? "bg-primary text-white"
            ...
            <button
              ...
              className="bg-primary text-white font-light text-sm px-10 py-3 rounded-full my-6"
            >
              Book an Appointment
            </button>
          </div>
        ) : (
          <h2 className="flex items-center justify-center my-20 text-4xl font-medium text-red-500">
