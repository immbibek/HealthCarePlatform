  ...
  return (
    <div className="flex items-center justify-between text-sm py-4 mb-5 border-b border-b-gray-400">
      ...
      <ul className="hidden md:flex items-start gap-5 font-medium">
        ...
        <a
          className="px-4 py-1 border border-gray-800 rounded-full hover:bg-primary hover:text-white hover:border-none transition-all duration-300"
      ...
      <div className="flex items-center gap-4">
        ...
        >
          ...
          <ul className="flex flex-col gap-2 items-center mt-5 px-5 text-lg font-medium">
            ...
            {token ? (
              <p className="px-4 py-2 rounded inline-block" onClick={logout}>
                LOGOUT
              </p>
            ) : (
